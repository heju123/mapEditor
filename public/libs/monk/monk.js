...
var commonUtil = {
    ...
    /** 根据后缀获取时间(单位：秒) */
    getTimeSecForSuffix: function getTimeSecForSuffix(time) {
     ...
     */
    removeExtraAttr: function removeExtraAttr(obj, compareObj, ignoreAttrs) {
        for (var key in obj) {
     ...
     * @param msg
     */
    popMessageTooltip: function popMessageTooltip(msg, opts) {
        alert(msg);
    }
};
...
var Input = function (_Scrollbar) {
    ...
    _createClass(Input, [{
        ...
        value: function draw(ctx) {
            ...
            this.setCommonStyle(ctx);
            //focus
            if (_globalUtil2.default.action.focusComponent === this && !this.style.readOnly) {
                //绘制光标
        ...
        value: function onFocus(mx, my) {
            ...
            _get(Input.prototype.__proto__ || Object.getPrototypeOf(Input.prototype), "onFocus", this).call(this, mx, my);
...
var Scrollbar = function (_Rect) {
    ...
    _createClass(Scrollbar, [{
        ...
        value: function onHover() {
            _get(Scrollbar.prototype.__proto__ || Object.getPrototypeOf(Scrollbar.prototype), "onHover", this).call(this);
            ...
            if (this.style.scrollText) {
                ...
                this.children.forEach(function (child) {
                    if (child !== _this3.scrollbarBaseLineV && child !== _this3.scrollbarBaseLineH) {
                        child.setStyle("scrollX", _this3.style.contentScrollX);
                    }
                });
            }
        }
            ...
            if (this.style.scrollText) {
                ...
                this.children.forEach(function (child) {
                    if (child !== _this4.scrollbarBaseLineV && child !== _this4.scrollbarBaseLineH) {
                        child.setStyle("scrollY", _this4.style.contentScrollY);
                    }
                });
            }
        }
        ...
        value: function produceLine(oritation, lineColor, alpha) {
            ...
            var Rect = __webpack_require__(1).default;
            ...
            line.setX(function () {
                return oritation === 1 ? _this5.getInnerWidth() - swidth : padding;
            });
            line.setY(function () {
                return oritation === 2 ? _this5.getInnerHeight() - swidth : padding;
            });
            if (oritation === 1) {
...
var _animationUtil = __webpack_require__(16);
    ...
    _createClass(Component, [{
        ...
        value: function initCfgStyle(cfgStyle) {
            for (var key in cfgStyle) {
                if (key === "hover" || key === "hoverout" || key === "active" || key === "activeout" || key === "focus" || key === "focusout") {
            ...
            if (cfg.events) {
                ...
                for (var type in cfg.events) {
                    ...
                    if (typeof funName === "function") //如果funName是function，则直接绑定
                        ...
                        } else if (controller && controller[funName] && typeof controller[funName] == "function") {
                        if (param) {
        ...
        value: function asyncGetView(viewCfg, resolve, reject) {
            ...
            _globalUtil2.default.eventBus.broadcastEvent("$onViewLoaded", event, true);
        ...
        value: function setCommonStyle(ctx) {
            ...
            if (this.style.scale !== undefined) {
                var scaleArr = this.style.scale.split(",");
                ctx.scale(scaleArr[0], scaleArr[1]);
                //要实现以组件中心来缩放，必须将ctx坐标原点平移
                var scaleWidth = this.getWidth() * scaleArr[0];
                var scaleHeight = this.getHeight() * scaleArr[1];
        ...
        key: "restoreStyle2Original",
        value: function restoreStyle2Original() {
            this.copyStyle(this.originalStyle);
            //删掉多余样式
            _commonUtil2.default.removeExtraAttr(this.style, this.originalStyle, "hover,hoverout,active,activeout,focus,focusout");
        }
            ...
            if (this.style.layout && this.style.layout.type && this.children.length > 0) {
                switch (this.style.layout.type) {
                    case "linearLayout":
                        ...
                        var hY = 0; //horizontal模式下的y坐标
                        var maxHeight = 0; //记录子组件最大高度值，自动换行时有用
                        this.children.forEach(function (child, index) {
                            var weight = 1;
                            if (child.style.layout && child.style.layout.layoutWeight) {
                            ...
                            if (!_this2.style.layout.orientation || _this2.style.layout.orientation === "horizontal") {
                                ...
                                if ((_this2.style.layout.autoLine === undefined || _this2.style.layout.autoLine === true) && !_this2.style.autoWidth && index > 0) {
                                    if (allWH + width > _this2.getInnerWidth()) {
                                        allWH = 0;
                                        hY += maxHeight;
                                        maxHeight = 0;
                                    }
        ...
        key: "doStyleAnimation",
        value: function doStyleAnimation(styleKey, toVal) {
            if (!this.animation || !this.animation[styleKey]) {
                return;
            }
            return _animationUtil2.default.executeStyleChange(this, styleKey, toVal, this.animation[styleKey]);
        }
        ...
        key: "copyStyle",
        value: function copyStyle(source) {
        ...
        key: "setStyle_kv",
        value: function setStyle_kv(key, value, doAni) {
        ...
        key: "setStyle_obj",
        value: function setStyle_obj(style, doAni) {
            var aniPromiseArr = [];
            var aniPromise = void 0;
        ...
        value: function getComponentByName(name) {
            if (this.name && this.name === name) {
                ...
                return _globalUtil2.default.viewState.getComponentInChildrenByKey("name", name, this);
            }
        }
        ...
        value: function getComponentsByName(name) {
            if (this.name && this.name === name) {
                ...
                return _globalUtil2.default.viewState.getComponentsInChildrenByKey("name", name, this);
            }
        }
        ...
        value: function getComponentsByType(type) {
            if (this.type && this.type === type) {
                ...
                return _globalUtil2.default.viewState.getComponentsInChildrenByKey("type", type, this);
            }
        }
        ...
        value: function triggerEvent(type) {
            _globalUtil2.default.eventBus.triggerEvent(type, this);
        }
    }, {
        key: "destroy",
        value: function destroy() {
...
var Checkbox = function (_Rect) {
    _inherits(Checkbox, _Rect);

    function Checkbox(parent) {
        _classCallCheck(this, Checkbox);

        var _this = _possibleConstructorReturn(this, (Checkbox.__proto__ || Object.getPrototypeOf(Checkbox)).call(this, parent));
    ...
    _createClass(Checkbox, [{
        key: "initCfg",
        value: function initCfg(cfg) {
            _get(Checkbox.prototype.__proto__ || Object.getPrototypeOf(Checkbox.prototype), "initCfg", this).call(this, cfg);
        ...
        key: "draw",
        value: function draw(ctx) {
            if (!_get(Checkbox.prototype.__proto__ || Object.getPrototypeOf(Checkbox.prototype), "draw", this).call(this, ctx)) {
                return false;
            }
...
var _fps = __webpack_require__(14);

var _fps2 = _interopRequireDefault(_fps);

var _httpUtil = __webpack_require__(29);
...
var _viewState = __webpack_require__(15);
...
var ViewState = function () {
    function ViewState(ctx) {
        ...
        this.registerEvent("mousedown", function (e) {
            if (_globalUtil2.default.action.hoverComponent) {
                if (_globalUtil2.default.action.focusComponent) {
                    _globalUtil2.default.action.focusComponent.onFocusout();
                }
                ...
                _globalUtil2.default.action.activeComponent.onActive(e.pageX, e.pageY);
        ...
        this.registerEvent("mouseup", function (e) {
            ...
            if (_globalUtil2.default.action.activeComponent) {
                _globalUtil2.default.action.activeComponent.onActiveout();
    ...
    _createClass(ViewState, [{
        ...
        value: function init(viewCfg) {
            ...
            _globalUtil2.default.eventBus.broadcastEvent("$onViewLoaded"); //view加载完成事件（所有同步加载的视图加载完毕）
        }
        ...
        value: function afterDraw(ctx) {
            ...
            if (ctx.mouseAction.hoverCom) {
                ...
                if (_globalUtil2.default.action.hoverComponent !== ctx.mouseAction.hoverCom) {
                    ...
                    _globalUtil2.default.action.hoverComponent.onHover();
                }
            }
        }
        ...
        value: function setVal2FocusCom() {
            if (!_globalUtil2.default.action.focusComponent.style.readOnly) //readOnly时禁止输入
                {
        ...
        key: "_getComponentsInChildrenByKey",
        value: function _getComponentsInChildrenByKey(retArr, key, val, com) {
            var children = com.getChildren();
            if (children) {
                if (children instanceof Array) {
                    var child = void 0;
        ...
        key: "getComponentsInChildrenByKey",
        value: function getComponentsInChildrenByKey(key, val, com) {
            var retArr = [];
        ...
        value: function getComponentByName(name) {
            if (this.rootComponent.name && this.rootComponent.name === name) {
                ...
                return _globalUtil2.default.viewState.getComponentInChildrenByKey("name", name, this.rootComponent);
            }
        }
...
var _TweenMaxMin = __webpack_require__(17);

var _TweenMaxMin2 = _interopRequireDefault(_TweenMaxMin);

var _EasePackMin = __webpack_require__(18);

var _EasePackMin2 = _interopRequireDefault(_EasePackMin);

var _ColorPropsPluginMin = __webpack_require__(19);
...
var animationUtil = {
     ...
     */
    executeStyleChange: function executeStyleChange(com, styleKey, toVal, animation) {
        return new Promise(function (resolve, reject) {
            var to = {};
            to[styleKey] = toVal;
            to.ease = _EasePackMin2.default[animation.easeType][animation.easing];
            ...
            animation.duration = _commonUtil2.default.getTimeSecForSuffix(animation.duration);
            _TweenMaxMin2.default.to(com.style, animation.duration, to);
        });
    }
};
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a,
    ...
    return a = 0 > a ? a + 1 : a > 1 ? a - 1 : a, 255 * (1 > 6 * a ? b + (c - b) * a * 6 : .5 > a ? c : 2 > 3 * a ? b + (c - b) * (2 / 3 - a) * 6 : b) + .5 | 0;
      ...
      g = function g(a, b) {
    var g, h, i, j, k, l, m, n, o, p, q;if (a) {
      if ("number" == typeof a) g = [a >> 16, a >> 8 & 255, 255 & a];else {
        if ("," === a.charAt(a.length - 1) && (a = a.substr(0, a.length - 1)), e[a]) g = e[a];else if ("#" === a.charAt(0)) 4 === a.length && (h = a.charAt(1), i = a.charAt(2), j = a.charAt(3), a = "#" + h + h + i + i + j + j), a = parseInt(a.substr(1), 16), g = [a >> 16, a >> 8 & 255, 255 & a];else if ("hsl" === a.substr(0, 3)) {
          if (g = q = a.match(c), b) {
        ...
        } else g = a.match(c) || e.transparent;g[0] = Number(g[0]), g[1] = Number(g[1]), g[2] = Number(g[2]), g.length > 3 && (g[3] = Number(g[3]));
      }
    } else g = e.black;return b && !q && (h = g[0] / 255, i = g[1] / 255, j = g[2] / 255, n = Math.max(h, i, j), o = Math.min(h, i, j), m = (n + o) / 2, n === o ? k = l = 0 : (p = n - o, l = m > .5 ? p / (2 - n - o) : p / (n + o), k = n === h ? (i - j) / p + (j > i ? 6 : 0) : n === i ? (j - h) / p + 2 : (h - i) / p + 4, k *= 60), g[0] = k + .5 | 0, g[1] = 100 * l + .5 | 0, g[2] = 100 * m + .5 | 0), g;
  },
      h = function h(a, b) {
    var c,
        d,
        ...
        f = (a + "").match(j) || [],
        h = 0,
        i = "";if (!f.length) return a;for (c = 0; c < f.length; c++) {
      ...
      k = _gsScope._gsDefine.plugin({ propName: "colorProps", version: "1.5.2", priority: -1, API: 2, global: !0, init: function init(a, c, d, e) {
      var f, h, i, j;this._target = a, this._proxy = h = "NUMBER" === (c.format + "").toUpperCase() ? {} : 0;for (f in c) {
        "format" !== f && (h ? (this._firstNumPT = i = { _next: this._firstNumPT, t: a, p: f, f: "function" == typeof a[f] }, h[f] = "rgb(" + g(i.f ? a[f.indexOf("set") || "function" != typeof a["get" + f.substr(3)] ? f : "get" + f.substr(3)]() : a[f]).join(",") + ")", j = c[f], "function" == typeof j && (j = j(e, a)), this._addTween(h, f, "get", "number" == typeof j ? "rgb(" + g(j, !1).join(",") + ")" : j, f, null, null, b)) : this._addTween(a, f, "get", c[f], f, null, null, b, e));
      }return !0;
    }, set: function set(a) {
      var b,
          c = this._firstNumPT;for (this._super.setRatio.call(this, a); c;) {
        b = g(this._proxy[c.p], !1), b = b[0] << 16 | b[1] << 8 | b[2], c.f ? this._target[c.p](b) : this._target[c.p] = b, c = c._next;
      }
    } });for (a in e) {
    j += "|" + a + "\\b";
  }j = new RegExp(j + ")", "gi"), k.colorStringFilter = b = function b(a) {
    var b,
        c = a[0] + " " + a[1];j.lastIndex = 0, j.test(c) && (b = -1 !== c.indexOf("hsl(") || -1 !== c.indexOf("hsla("), a[0] = h(a[0], b), a[1] = h(a[1], b));
...
var _eventListener = __webpack_require__(22);

var _eventListener2 = _interopRequireDefault(_eventListener);

var _clickEvent = __webpack_require__(23);

var _clickEvent2 = _interopRequireDefault(_clickEvent);

var _mouseEvent = __webpack_require__(24);

var _mouseEvent2 = _interopRequireDefault(_mouseEvent);

var _keyEvent = __webpack_require__(25);

var _keyEvent2 = _interopRequireDefault(_keyEvent);

var _wheelEvent = __webpack_require__(26);

var _wheelEvent2 = _interopRequireDefault(_wheelEvent);

var _stack = __webpack_require__(27);

var _stack2 = _interopRequireDefault(_stack);

var _eventNotify = __webpack_require__(28);
...
var EventBus = function () {
    ...
    _createClass(EventBus, [{
        ...
        key: "broadcastEvent",
        value: function broadcastEvent(type, event, toChildren) {
            var _this4 = this;
            ...
            this.eventListeners[type].forEach(function (listener) {
                if (listener.callback && typeof listener.callback === "function") {
                    ...
                    if (!event || !event.currentTarget) {
                        ...
                        var currentTargetCom = _this4.getComponentByTarget(event.currentTarget);
                        var targetCom = _this4.getComponentByTarget(listener.target);
                        if (targetCom && currentTargetCom) {
                            if (!toChildren && currentTargetCom === targetCom) {
                                listener.callback(event);
                            } else if (toChildren && (currentTargetCom === targetCom || currentTargetCom.parentOf(targetCom))) {
                                listener.callback(event);
                            }
                        }
                    }
        ...
        key: "getComponentByTarget",
        value: function getComponentByTarget(target) {
            var targetCom = void 0;
            if (target instanceof _component2.default) {
                targetCom = target;
            } else if (target instanceof _controller2.default) {
        ...
        key: "triggerEvent",
        value: function triggerEvent(type, com) {
            var eventNotify = new _eventNotify2.default();
            eventNotify.set({
                type: type,
                listener: {
                    type: type,
 ...
 */
var httpUtil = {
    getGetParamStr: function getGetParamStr(param) {
        var str = "";
        if (param != undefined) {
